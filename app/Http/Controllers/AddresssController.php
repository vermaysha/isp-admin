...
class AddresssController extends Controller
{
    ...
    {
        $city = City::select('id', 'code', 'name')->where('province_code', $provinceCode);
    ...
    {
        $districts = District::select('id', 'code', 'name')->where('city_code', $cityCode);
    ...
    {
        $villages = Village::select('id', 'code', 'name')->where('district_code', $districtCode);
